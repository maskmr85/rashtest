...
//
function RashnewCount($total,$todaycounts,$yescounts,$month,$year,$lastyear,$cudate,$lastmonth){
global $d;
...
if(!defined('admin') && (!defined("ajax_head"))){
++$total;
if ( $CurrentYear == $year )
{
...
++$monthcounts;
++$yearcounts;
RashnewCount($total,$todaycounts,$yescounts,$monthcounts,$yearcounts,$lastyearcounts,$cudate,$lastmonthcounts);
